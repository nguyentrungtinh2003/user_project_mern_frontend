...
const DropdownMenuPortal = ({ ...props }) => {
  return (
    <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-patol" {...props} />
  );
};

const DropdownMenuTrigger = ({ ref, ...props }) => {
  return (
...
DropdownMenuTrigger.display = DropdownMenuPrimitive.Trigger.displayName;
...
const DropdownMenuLabel = ({ className, inset, ...props }) => {
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        `px-1.5 py-2 text-sm font-medium data-[inset]:pl-8`,
        className,
      )}
      {...props}
    />
